...
<div class="container mt-5">
  ...
  <p><strong>Guest Name:</strong> <?php echo $guest['first_name'] . ' ' . $guest['last_name']; ?></p>
  <p><strong>Check-in Date:</strong> <?php echo $reservation['check_in_date']; ?></p>
  <p><strong>Check-out Date:</strong> <?php echo $reservation['check_out_date']; ?></p>
  <p><strong>Status:</strong> <?php echo $reservation['reservation_status']; ?></p>
